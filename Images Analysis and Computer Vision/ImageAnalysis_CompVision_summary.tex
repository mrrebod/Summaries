...
\begin{document}
	...
	\begin{multicols*}{4}
		...
		\end{enumerate}
		In this course we mainly only look at physical optics and the wave character of light. 		
		\subsubsection{Light as an EM waves}
		...
		\end{enumerate}
		 We look at few of those in more detail:\par 
